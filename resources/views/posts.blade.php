    ...
    <div class="my-4 py-4 px-4 mx-auto max-w-screen-xl lg:px-0">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            @forelse ($posts as $post)
                <article
                    class="p-6 bg-white flex flex-col justify-between rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            @empty
                <div>
                    ...
                    <a href="/posts" class="block text-blue-600 text-xs hover:underline">&laquo; Back to all posts</a>
                </div>
            @endforelse
        </div>
    </div>
